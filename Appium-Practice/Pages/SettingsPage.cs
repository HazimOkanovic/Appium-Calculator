...
public class SettingsPage : BasePage
{
    ...
    private readonly By AccountSettingsButton = MobileBy.XPath("//android.widget.LinearLayout[3]//android.widget.TextView");
    private readonly By LogOutButton = MobileBy.XPath("//android.widget.LinearLayout[5]//android.widget.TextView");
    private readonly By LogInButton = MobileBy.XPath("//android.widget.LinearLayout[3]//android.widget.TextView");
